...
public class Main {
    ...
    public static int daemonID;
    public static int daemonMemory;
    ...
    private static void loadConfig() {
        try {
            ...
            if (!conf.exists()) {
                ...
                writer.write("daemon_id=1\n");
                writer.write("database=jdbc:mysql://n1.domvps.net:3306/MCP\n");
            ...
            daemonMemory = Integer.parseInt(p.getProperty("memory"));
            daemonID = Integer.parseInt(p.getProperty("daemon_id"));
